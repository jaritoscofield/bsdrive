    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center">
            ...
            <div class="text-lg font-bold text-neutral-900">
                @if($lastAccess)
                    {{ Carbon::parse($lastAccess)->diffForHumans(null, null, false, 2) }}
                @else
                    Nunca
                @endif
            </div>
        ...
        <div class="flex items-start">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-blue-700">
                    ...
                    <p class="mt-1">
                        <a href="{{ route('shared-drive-setup') }}" class="underline font-medium">Ver detalhes da configuração</a>
                    </p>
                </div>
            </div>
        </div>
                ...
                @forelse($recentActivities as $activity)
                    <li class="py-3 flex items-center space-x-4">
                        ...
                        <div class="text-xs text-neutral-400">
                            {{ $activity['date'] ? Carbon::parse($activity['date'])->diffForHumans(null, null, false, 2) : '' }}
                        </div>
                    </li>
                @empty
