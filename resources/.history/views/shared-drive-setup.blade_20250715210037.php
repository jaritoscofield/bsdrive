...
<body>
    ...
    <div class="step">
        ...
        <ul>
            <li>Uploads vão direto para o Google Drive da Service Account</li>
    ...
    <div class="step">
        ...
        <h3>1️⃣ Acesse o Google Drive</h3>
    ...
    <h2>🔍 Links Úteis:</h2>
    <ul>
        <li><a href="/list-shared-drives">🔍 Ver Shared Drives Disponíveis</a></li>
        <li><a href="/system-diagnostics">⚙️ Diagnóstico do Sistema</a></li>
