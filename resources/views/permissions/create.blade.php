...
@section('title', 'Criar Permissão - BSDrive')
...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-neutral-900">Criar Nova Permissão</h1>
                <p class="text-neutral-600">Defina uma nova permissão no sistema</p>
            </div>
        ...
        <form action="{{ route('permissions.store') }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description"
                              ...
                              class="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-neutral-500 focus:border-neutral-500 transition-colors @error('description') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mt-6 p-4 bg-neutral-50 rounded-lg border border-neutral-200">
                ...
                <div class="text-sm text-neutral-600">
                    <p><strong>Slug:</strong> <span id="slug-preview" class="font-mono text-neutral-800">-</span></p>
                    <p><strong>Descrição:</strong> <span id="description-preview" class="text-neutral-800">-</span></p>
                </div>
            </div>
