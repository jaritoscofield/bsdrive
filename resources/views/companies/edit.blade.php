...
@section('title', 'Editar Empresa - BSDrive')
...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-neutral-900">Editar Empresa</h1>
            <p class="text-neutral-600">Edite os dados da empresa</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="cnpj" id="cnpj" value="{{ old('cnpj', $company->cnpj) }}" required placeholder="00.000.000/0000-00"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone', $company->phone) }}" placeholder="(11) 99999-9999"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="max_storage_mb" id="max_storage_mb" min="1" step="1" value="{{ old('max_storage_mb', $company->max_storage_mb) }}"
                                   placeholder="Ex: 100"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="address" id="address" rows="3" placeholder="Digite o endereço completo da empresa"
                                      class="w-full pl-10 pr-3 py-2 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:border-transparent @error('address') border-red-500 @enderror">{{ old('address', $company->address) }}</textarea>
                        </div>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="active" value="1" {{ old('active', $company->active) ? 'checked' : '' }}
                                   class="rounded border-neutral-300 text-neutral-900 shadow-sm focus:border-neutral-300 focus:ring focus:ring-neutral-200 focus:ring-opacity-50">
                            <span class="ml-2 text-sm text-neutral-700">Empresa ativa</span>
                        </label>
                    </div>
                </div>
