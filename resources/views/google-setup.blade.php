...
@section('title', 'Configuração BSDrive')
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-2xl font-bold text-gray-900">
                🔧 Configuração BSDrive
            </h1>
            <p class="text-gray-600 mt-2">Configure a integração com BSDrive para uploads sem Shared Drive</p>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="mb-8">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <div class="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
                        ...
                        <span class="text-yellow-700">Após configurar o .env, execute <code>php artisan config:clear</code> para limpar o cache</span>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <button id="test-upload-btn" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-medium transition-colors" disabled>
                        📤 Testar Upload
                    </button>
                </div>
            </div>
            ...
            <!-- Logs -->
            <div class="mt-8">
                <h2 class="text-lg font-semibold mb-4">📝 Logs de Debug</h2>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch('{{ route("google.status") }}')
            ...
            .then(data => {
                if (data.authenticated) {
                    ...
                    testUploadBtn.classList.remove('opacity-50');
                } else {
                    authStatusDiv.innerHTML = `
                    ...
                    testUploadBtn.classList.add('opacity-50');
                }
            })
            .catch(error => {
                authStatusDiv.innerHTML = `
    ...
    revokeBtn.addEventListener('click', function() {
        if (confirm('Tem certeza que deseja remover a autorização do BSDrive?')) {
            ...
            form.method = 'POST';
            form.action = '{{ route("google.revoke") }}';
            form.innerHTML = '@csrf';
    ...
    testUploadBtn.addEventListener('click', function() {
        alert('🚧 Em breve: Página de teste de upload específica para OAuth');
    });
