...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-neutral-600">{{ $company->name }} - Adicione uma pasta que a empresa poderá acessar</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-neutral-200">
        <div class="p-6">
            <form action="{{ route('companies.folders.store', $company) }}" method="POST" class="space-y-6">
                @csrf
